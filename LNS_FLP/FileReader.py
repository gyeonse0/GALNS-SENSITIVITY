...
class FileReader:
    ...
    def randomize_vrp_data(self, data, time=None, max_value=None, key_seed=None):
        ...
        time_slots = np.array([0, 30, 60, 90, 120, 150, 180]) # 540은 0이라고 생각
        ...
        if time is not None:
            while True:
                new_values = np.random.choice(time_slots, size=values_except_depot.shape, p= [0.6, 0.4/6, 0.4/6, 0.4/6, 0.4/6, 0.4/6, 0.4/6])
