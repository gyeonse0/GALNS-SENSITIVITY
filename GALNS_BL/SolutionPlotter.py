...
class SolutionSaver:
    ...
    def __init__(self, filename, current_states, min_index, initial_truck, ga_count, k_opt_count, execution_time, min_objective_time, revenue, outcome_counts, destroy_counts, repair_counts):
    ...
    def save_to_desktop(self, filename):
        ...
        desktop = r"C:\Users\User\OneDrive\바탕 화면"
