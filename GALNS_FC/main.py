...
# 파일이 이미 열려 있는지 확인
save_file_path = r'C:\Users\User\OneDrive\바탕 화면\sensitivity_analysis_results_FC.xlsx'
...
def initialize_data(data, speed_t, drone_charging, drone_payload, service_time, temperature):
...
save_to_excel(r'C:\Users\User\OneDrive\바탕 화면\sensitivity_analysis_results_FC.xlsx', 'Resuwwdwadwdwdwltsdd4321', results)
