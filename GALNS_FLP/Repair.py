...
class Repair():
    ...
    def randforesrt_kwh_km(self,efficiency, temperature):
        ...
        energy_efficiency = efficiency  * recovered_efficiency 
    ...
    def soc_calculate(self, route):
        ...
        for idx in range(1, len(route)):
            if route[idx][1] == CATCH or ((route[idx][1] == FLY) and (route[idx-1][1] in [ONLY_TRUCK, ONLY_DRONE])):
                ...
                truck_energy_consumption = (data["edge_km_t"][route[idx-jump-1][0]][route[idx][0]]*data["curvy_road"]) * self.randforesrt_kwh_km(data["energy_kwh/km_t"],data["temperature"])
